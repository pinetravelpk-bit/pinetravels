...
// Sitemap, robots, canonical tags aur JSON-LD sab isay use karte hain.
// Domain badalna ho to sirf yahan ya .env me NEXT_PUBLIC_SITE_URL set karein.
export const SITE_URL = (process.env.NEXT_PUBLIC_SITE_URL || "https://pinetravel.pk").replace(/\/$/, "");
